...
NWR_kstep <- function(NWR,
  ...
  NWR_opt <- function(NWR_dat){
    ...
    optim_pars <- function(...){
      ...
      mylist$par <- c(c(Ut %*% NWR$U %*% NWR$gamma), NWR$beta0, NWR$s2, NWR$rho)
